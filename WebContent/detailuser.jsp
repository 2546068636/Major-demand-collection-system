...
<body>
	<form class="layui-form" id="form" onsubmit="return checkAll();">
		<a title="返回" class="layui-btn"
			href="${pageContext.request.contextPath}/listuser.jsp"> <i
		...
		<div class="layui-main" style="margin-top: 50px; width: 600px;">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="username" disabled required
						value="${param.username }" lay-verify="required|username"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="name" disabled required
						value="${param.name }" lay-verify="required" placeholder="请输入真实姓名"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="credit" disabled required
						value="${param.credit }" lay-verify="required|identity"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="radio" disabled name="sex" value="男"
						${param.sex == '男'?"checked":""} title="男"> <input
						type="radio" disabled name="sex" value="女"
						${param.sex == '女'?"checked":""} title="女">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label" style="font-size: 17px">邮箱</label>
				<div class="layui-input-inline">
					<input type="text" name="yx" required lay-verify="email" disabled
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="dept" required lay-verify="required"
						disabled value="${param.dept }" placeholder="请输入工作单位"
						autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="post" required lay-verify="" disabled
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="gddh" required lay-verify="phone" disabled
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="province" lay-verify="" disabled>
						<option value=""></option>
			...
			<!-- 			  <div class="layui-form-item">
				    <div class="layui-input-inline" style="margin-left: 117px;margin-top: 10px;">
