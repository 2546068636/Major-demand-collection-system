...
<body style="margin-top: 15px; margin-left: 33px;">
	...
	<form class="layui-form" method="post" id="form"
		...
		<div class="layui-form-item" pane="">
			<label class="layui-form-label"
				style="font-size: 12px; font-style: SimHei">形式审核是否同意</label>
			<div class="layui-input-block">
				<input type="radio" lay-filter="isornot" disabled name="isornotxs"
					value="同意" ${param.status == '同意'?"checked":""} />同意
				<!-- 单选按钮的name要一样 -->
				<input type="radio" lay-filter="isornot" disabled name="isornotxs"
					value="不同意" ${param.status == '不同意'?"checked":""} />不同意
				<!-- selected 和它的区别是什么？都是选择 -->
			</div>
		</div>

		<label class="layui-form-label  reason1"
			style="font-size: 12px; font-style: SimHei;">形式审核意见</label>
		<div class="layui-input-block ">

			<textarea name="xscomment" disabled placeholder="请输入不同意的理由"
				class="layui-textarea reason2">${param.xscomment }</textarea>
		</div>
		...
		<div class="layui-form-item" pane="">
			<label class="layui-form-label"
				style="font-size: 12px; font-style: SimHei">部门审核是否同意</label>
			<div class="layui-input-block">
				<input type="radio" lay-filter="isornot" disabled name="isornotbm"
					value="同意" ${param.bmstatus == '不同意'?"checked":""} />同意
				<!-- 单选按钮的name要一样 -->
				<input type="radio" lay-filter="isornot" disabled name="isornotbm"
					value="不同意" ${param.bmstatus == '不同意'?"checked":""} />不同意
				<!-- selected 和它的区别是什么？都是选择 -->
			</div>
		</div>
		...
		<label class="layui-form-label  reason1" disabled
			style="font-size: 12px; font-style: SimHei;">部门审核意见</label>
		<div class="layui-input-block ">

			<textarea name="xscomment" disabled placeholder="请输入不同意的理由"
				class="layui-textarea reason2">${param.bmcomment }</textarea>
		</div>
