...
<body style="margin-top: 15px; margin-left: 0px;">
	...
	<form class="layui-form"
		action="${pageContext.request.contextPath}/xuqiuservlet?method=xsflcx"
		method="post">
