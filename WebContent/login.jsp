...
<script type="text/javascript">
	$(function() {
		...
		$("#vcodeImg").click(
				function() {
					this.src = "CpachaServlet?method=loginCapcha&t="
							+ new Date().getTime();
				});
...
<title>重大技术需求征集调查系统</title>
<meta name="keywords" content="河北省重大技术需求征集调查系统">
</head>
<body>

	<div class="header" style="padding: 0;">
		<h2
			style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">重大技术需求征集调查系统</h2>
	</div>
