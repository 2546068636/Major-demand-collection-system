...
<script type="text/javascript">
	$(function() {
		...
		$("#btn").click(function() {
			...
			$.ajax({
				type : "post",
				url : "xuqiuservlet?method=updatexq",
				data : data,
				...
				success : function(msg2) {
					if (msg2.state == 1) {
						...
						setTimeout('window.location.href="listxq.jsp"', 1000);//setTimeout是js附带的延缓执行函数
						/* layer.alert('jsjsjsj', function(index){

						    window.location.href="listxq.jsp"; 
							layer.close(index);
						　　}); */
	...
	<form class="layui-form" method="post" id="form">
		...
		<div style="margin-top: 25px;">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="organizationName"
						value="${param.organizationName}" required lay-verType="tips"
						lay-verify="required" autocomplete="off" class="layui-input">
					<input type="hidden" value="${param.name }" name="name"> <input
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="web" value="${param.web }"
			...
			<div class="layui-form-item">
				...
				<div style="float: right;">
					...
					<div class="layui-input-inline">
						<input type="text" name="post" value="${param.post }"
							autocomplete="off" class="layui-input">
					</div>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div style="float: right;">
					...
					<div class="layui-input-inline">
						<input type="text" name="gddh" value="${param.gddh }"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="xqname" value="${param.xqname }"
						lay-verType="tips" required lay-verify="required"
						autocomplete="off" class="layui-input">
				</div>
				<div style="float: right;">
					<div class="layui-inline">
						...
						<div class="layui-input-inline" style="width: 100px;">
							<input type="text" id="test3" value="${param.qsyear }"
						...
						<div class="layui-input-inline"
							...
							<input type="text" id="test4" value="${param.jzyear }"
		...
		<div class="layui-form-item ">
			...
			<div class="layui-input-inline">
				<input type="text" name="keyword2" value="${param.keyword2 }"
					lay-verType="tips" required lay-verify="required"
					autocomplete="off" class="layui-input keyword2">

			</div>
			<div class="layui-input-inline">
				<input type="text" name="keyword3" value="${param.keyword3 }"
					lay-verType="tips" required lay-verify="required"
					autocomplete="off" class="layui-input keyword3">

			</div>
			<div class="layui-input-inline">
				<input type="text" name="keyword4" value="${param.keyword4 }"
					lay-verType="tips" required lay-verify="required"
					autocomplete="off" class="layui-input keyword4">

			</div>
			<div class="layui-input-inline">
				<input type="text" name="keyword5" value="${param.keyword5 }"
					lay-verType="tips" required lay-verify="required"
					autocomplete="off" class="layui-input keyword5">
		...
		<div class="layui-form-item" pane="">
			...
			<div class="layui-input-block">
				<input type="radio" id="medel"
					${param.solution == '独立研发'?"checked":""} name="solution"
					value="独立研发" />独立研发 <input type="radio" id="medel"
					${param.solution == '委托研发'?"checked":""} name="solution"
					value="委托研发" />委托研发 <input type="radio" id="medel"
					${param.solution == '合作研发'?"checked":""} name="solution"
					value="合作研发" />合作研发 <input type="radio" id="medel"
					${param.solution == '其他'?"checked":""} name="solution" value="其他" />其他
			</div>
		</div>
		<div class="layui-form-item" pane="">
			<label class="layui-form-label"
			...
			<div class="layui-input-block">
				<input type="radio" lay-filter="filter" name="type" value="基础研究"
					${param.type == '基础研究'?"checked":""} />基础研究
				<!-- 单选按钮的name要一样 -->
				<input type="radio" lay-filter="filter" name="type" value="应用研究"
					${param.type == '应用研究'?"checked":""} />应用研究
				<!-- selected 和它的区别是什么？都是选择 -->
				<input type="radio" lay-filter="filter" name="type" value="试验发展"
					${param.type == '试验发展'?"checked":""} />试验发展 <input type="radio"
					lay-filter="filter" name="type" value="研究与试验发展成果应用"
					${param.type == '研究与试验发展成果应用'?"checked":""} />研究与试验发展成果应用 <input
					type="radio" lay-filter="filter" name="type" value="技术推广与科技服务"
					${param.type == '技术推广与科技服务'?"checked":""} />技术推广与科技服务 <input
					type="radio" lay-filter="filter" name="type" value="生产性活动"
					${param.type == '生产性活动'?"checked":""} />生产性活动
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text talk">
			...
			<div class="layui-input-block">
				<textarea name="other" lay-verType="tips" value="${param.other }"
					lay-verify="clength" placeholder="请输入内容"
		...
		<div class="layui-form-item indust">
			...
			<div class="layui-input-block">
				<input type="text" value="${param.hangye }" name="hangye"
		...
		<div class="layui-form-item">
			<div class="layui-input-inline"
				...
				<button class="layui-btn" id="btn" lay-submit lay-filter="*">确认更改</button>
